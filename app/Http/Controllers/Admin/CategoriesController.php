...
class CategoriesController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $lists = Categories::when(!empty($q), function ($query) use ($q) {
        ...
        return view('admin/categories/index', compact('title', 'lists', 'q', 'sort'))->render();
    }

    public function create() {
        $title = 'Add Category';

        $html = view('admin/categories/form', compact('title'))->render();
    ...
    public function store(Request $request) {
        ...
        if ($model->save()) {
            ...
            return response()->json(array('success' => true, 'message' => 'Category is saved successfully.'));
        }
    ...
    public function edit($id) {
        ...
        $html = view('admin/categories/form', compact('title', 'model'))->render();
        return response()->json(array('success' => true, 'html' => $html));
    }
