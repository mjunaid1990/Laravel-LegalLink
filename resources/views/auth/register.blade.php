...
<section class="sign-up">
    <div class="row">
        <div class="col-12 col-md-6 sign-up-pd">
            ...
            <h6 class="mt-2">Already have account? <a href="/login">Log in</a></h6>
        </div>

        <div class="col-12 col-md-6 sign-up-bg" style="height: auto;background-image:url('assets/img/legal/bg-auth-gradient.png');background-repeat: no-repeat;
