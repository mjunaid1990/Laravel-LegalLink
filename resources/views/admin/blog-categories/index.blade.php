...
<div class="row mb-4">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-grp-actions">
            <div class="d-flex">
                <a href="javascript:void(0);" data-url="/admin/blog-categories/create" class="btn btn-primary sidebar-modal">
                            ...
                            <td class="action">
                                ...
                                <div class="dropdown-menu dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                                    <div class="bg-white dark__bg-1000 rounded-2">
                                        ...
                                        <a class="dropdown-item sidebar-modal" href="javascript:void(0);" data-url="/admin/blog-categories/edit/{{$model->id}}">
                                            Edit
                                        </a>
                                        ...
                                        <a class="dropdown-item text-danger" data-method="DELETE" href="javascript:void(0)" 
                                           onclick="if(!confirm('Are you sure you want to delete?')){return false;} event.preventDefault();
                                            ...
                                            <form method="post" id="delete-form-{{$model->id}}" action="{{ route('admin.blogcategory.delete', $model->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('delete')
